...
BEGIN
   ...
   dout <= x_coord_internal(7) AND x_coord_internal(6);

   -- ModuleWare code(v1.12) for instance 'U_8' of 'and'
   dout1 <= x_coord_internal(1) AND x_coord_internal(0);

   -- ModuleWare code(v1.12) for instance 'and_L' of 'and'
   and_l_to_merge <= deb_btn(0) AND NOT(dout);

   -- ModuleWare code(v1.12) for instance 'and_r' of 'and'
   and_r_to_merge <= NOT(dout1) AND deb_btn(3);
