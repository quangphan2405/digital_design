...
BEGIN
   ...
   alien_defeated_internal <= mw_U_1reg_cval;
   ...
   -- ModuleWare code(v1.12) for instance 'const_1' of 'constval'
   dout1 <= '1';
   ...
   u_6combo_proc: PROCESS(alien_color_internal, dead_red, hit)
   BEGIN
      CASE hit IS
   ...
   u_11combo_proc: PROCESS(alien_defeated_internal, dout1, hit)
   BEGIN
      CASE hit IS
      WHEN '0' => dout <= alien_defeated_internal;
      WHEN '1' => dout <= dout1;
      WHEN OTHERS => dout <= 'X';
      END CASE;
