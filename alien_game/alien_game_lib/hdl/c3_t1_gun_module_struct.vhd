...
BEGIN
   ...
   y_coord <= mw_U_0reg_cval;
   u_0seq_proc: PROCESS (clk, rst_n)
   BEGIN
      IF (rst_n = '0') THEN
         mw_U_0reg_cval <= "10000000";
   ...
   x_coord <= mw_U_1reg_cval;
   u_1seq_proc: PROCESS (clk, rst_n)
   BEGIN
      IF (rst_n = '0') THEN
         mw_U_1reg_cval <= "00010000";
      ELSIF (clk'EVENT AND clk='1') THEN
   ...
   coord_x <= mw_x_coordreg_cval;
   x_coordseq_proc: PROCESS (clk, rst_n)
   BEGIN
      IF (rst_n = '0') THEN
         mw_x_coordreg_cval <= "00001000";
      ELSIF (clk'EVENT AND clk='1') THEN
         mw_x_coordreg_cval <= cur_x;
      END IF;
