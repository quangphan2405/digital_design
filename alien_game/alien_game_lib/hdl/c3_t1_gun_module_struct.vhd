...
BEGIN
   ...
   l_shift <= NOT(cur_x(6)) AND btn(1) AND enable;

   -- ModuleWare code(v1.12) for instance 'r_shift' of 'and'
   r_shift <= enable AND btn(3) AND NOT(cur_x(1));
   ...
   x_movecombo_proc: PROCESS(cur_x, x_right_shift, x_left_shift, dir)
   BEGIN
      CASE dir IS
      WHEN "00" => dout <= cur_x;
