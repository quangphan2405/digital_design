-- VHDL Entity alien_game_lib.c3_t2_simple_top_level.symbol
--
-- Created:
--          by - USER.UNKNOWN (QUANG-PHAN)
--          at - 15:44:06 05/31/2020
--
...
ENTITY c3_t2_simple_top_level IS
   PORT( 
...
END c3_t2_simple_top_level ;

--
-- VHDL Architecture alien_game_lib.c3_t2_simple_top_level.struct
--
-- Created:
--          by - USER.UNKNOWN (QUANG-PHAN)
--          at - 15:44:06 05/31/2020
...
ARCHITECTURE struct OF c3_t2_simple_top_level IS
   ...
   FOR ALL : c3_t2_write_seq USE ENTITY alien_game_lib.c3_t2_write_seq;
...
BEGIN
   ...
   u_4combo_proc: PROCESS(alien_x_coord, gun_x_coord, module_select)
   BEGIN
   ...
   u_5combo_proc: PROCESS(alien_y_coord, gun_y_coord, module_select)
   BEGIN
      CASE module_select IS
