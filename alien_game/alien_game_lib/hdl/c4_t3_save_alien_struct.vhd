-- VHDL Entity alien_game_lib.c4_t3_save_alien.symbol
--
-- Created:
--          by - USER.UNKNOWN (QUANG-PHAN)
--          at - 17:12:52 05/31/2020
--
...
END c4_t3_save_alien ;

--
-- VHDL Architecture alien_game_lib.c4_t3_save_alien.struct
--
-- Created:
--          by - USER.UNKNOWN (QUANG-PHAN)
--          at - 17:12:52 05/31/2020
...
ARCHITECTURE struct OF c4_t3_save_alien IS
...
BEGIN
   ...
   BEGIN
      IF (rst_n = '0') THEN
         mw_U_8reg_cval <= "000000001100111100000000";
      ELSIF (clk'EVENT AND clk='1') THEN
   ...
   hit_once_internal <= mw_U_15reg_cval;
   u_15seq_proc: PROCESS (clk, rst_n)
   BEGIN
      IF (rst_n = '0') THEN
         mw_U_15reg_cval <= '0';
      ELSIF (clk'EVENT AND clk='1') THEN
         mw_U_15reg_cval <= dout1;
      END IF;
   ...
   u_17combo_proc: PROCESS(hit_once_internal, one, dout3)
   BEGIN
      CASE dout3 IS
      WHEN '0' => dout1 <= hit_once_internal;
      WHEN '1' => dout1 <= one;
      WHEN OTHERS => dout1 <= 'X';
      END CASE;
