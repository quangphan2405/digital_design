...
BEGIN
   ...
   colorcombo_proc: PROCESS(gun_color, alien_color, bullet_color, 
                            victory_color, module_select)
   BEGIN
      CASE module_select IS
      WHEN "00" => color <= gun_color;
      WHEN "01" => color <= alien_color;
   ...
   x_coordcombo_proc: PROCESS(gun_x_coord, alien_x_coord, bullet_x_coord, 
                              victory_x_coord, module_select)
   BEGIN
      CASE module_select IS
      WHEN "00" => x_coord <= gun_x_coord;
      WHEN "01" => x_coord <= alien_x_coord;
   ...
   y_coordcombo_proc: PROCESS(gun_y_coord, alien_y_coord, bullet_y_coord, 
                              victory_y_coord, module_select)
   BEGIN
      CASE module_select IS
      WHEN "00" => y_coord <= gun_y_coord;
      WHEN "01" => y_coord <= alien_y_coord;
